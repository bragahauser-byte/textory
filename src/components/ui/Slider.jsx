...
function Slider({ value, onChange, min = 0, max = 100, step = 1, steps, className = '' }) {
  ...
  return (
    ...
    >
      <span className="absolute left-0 right-0 top-1/2 h-2 -translate-y-1/2 rounded-full bg-[#D9D9D9]" style={{ background: `linear-gradient(to right, #1A1A1A ${visualPercentage}%, #D9D9D9 ${visualPercentage}%)` }} />
