  ...
  return (
    <main className="screen-shell relative flex min-h-screen flex-col bg-white text-[#111111]">
      <header className="flex items-start justify-between">
        ...
        <div className="flex gap-3"><button type="button" aria-label={t('itemReady.delete')} onClick={() => setDeleteOpen(true)} className="top-control flex items-center justify-center rounded-full bg-[#FFC3C4] text-[#ef233c] focus:outline-none focus:ring-2 focus:ring-[#ef233c]"><Trash2 size={24} strokeWidth={2.3} aria-hidden="true" /></button><button type="button" aria-label={t('itemReady.edit')} onClick={onEdit} className="top-control flex items-center justify-center rounded-full bg-[#f5f5f5] focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-4"><Pencil size={24} strokeWidth={2.3} aria-hidden="true" /></button></div>
      </header>
